...
import { getApplication, createApplication, updateApplication, deleteApplication } from '../../api';
...
export function ApplicationForm({ id, parentId, mode, onSaved, onDeleted }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      if (isNew) {
        await createApplication({ name, app_grouping_id: parentId!, description: description || undefined });
      } else {
